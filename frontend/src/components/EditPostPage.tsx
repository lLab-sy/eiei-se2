...
//         console.log("Data fetched from mockDatabase:", data); // ดูข้อมูลที่ได้
...
//     console.log("Form submitted with values:", values, postId); // ✅ Debug เช็คค่าที่ส่งมา
...
//     console.log("🔄 Redux state updated with:", updatedData);

//     console.log("🚀 Data update complete! Showing toast...", postId); // ✅ Debug จุดที่สาม
...
//                   <Select
//                     value={form.watch("type")} // ใช้ค่า form.watch แทน mediaType
//                     onValueChange={(
//                       value: "media" | "short" | "drama" | "ads",
//                     ) => {
//                       dispatch(setMediaType(value));
//                       form.setValue("type", value); // ✅ อัปเดตค่าใน useForm
//                     }}
//                   >
//                     <SelectTrigger>
...
//                       form.setValue("roles", updatedRoles); // ✅ อัปเดตค่าใน useForm
//                     }}
//                   />
//                 </div>
//                 <div>
