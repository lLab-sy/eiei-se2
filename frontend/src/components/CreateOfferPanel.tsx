...
export default function CreateOfferPanel(){
    const { data: session } = useSession();
    const reqPid  = useParams()
    const pid=reqPid.pid!.toString()
 ...
 useEffect(() => {
   ...
   return(
       <div className="flex bg-mainblue-light justify-center min-h-screen w-full">
